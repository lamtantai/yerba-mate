...
const IconButton = ({ href, icon, showBadge = false }) => (
  <motion.li className="mr-2 rounded-full bg-[--color-header-button] hover:bg-[--color-header-button-hover]">
    <Link
      href={href}
...
export default function Header() {
  ...
  return (
    <>
      ...
      <SlideInDown zIndex="z-50">
        <motion.header
          className="fixed top-0 w-full bg-black py-[--header-height-padding] opacity-90 backdrop-blur-sm"
          initial="initial"
          variants={translateY}
        ...
        >
          <div className="flex h-[--header-height-inner] justify-between px-5">
            ...
            <nav className="flex h-full">
              ...
              {/* BUTTON MENU */}
              <motion.button
                className="mr-14 flex size-10 items-center justify-center rounded-full bg-[--color-header-button] hover:bg-[--color-header-button-hover]"
                variants={variants}
                initial="initial"
